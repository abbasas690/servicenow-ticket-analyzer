...
if (G) G.SnCache = { QUERY_TTL_MS, TIMELINE_TTL_MS, queryKey, isFreshQuery, timelineNeedsFetch, getQuery, putQuery, getTimelines, putTimelines, purgeExpired, clearAll };
