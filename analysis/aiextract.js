...
function tidyRootCause(v) {
  ...
  s = s.replace(/^root\s*ca?us?e\s*(is)?\s*[::-]?\s*/i, "");
...
if (G) G.AiExtract = { AI_MODELS, buildClosurePrompt, parseClosureJson, classifySolution };
if (typeof module !== "undefined" && module.exports) {
  module.exports = { AI_MODELS, buildClosurePrompt, parseClosureJson, classifySolution };
}
